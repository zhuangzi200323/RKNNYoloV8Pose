...
Java_com_sq_rknn_rknnyolov8pose_YoloV8PoseDetect_detect2(JNIEnv *env, jobject thiz, jobject jbitmap) {
    ...
    // 获取 Java 类和构造函数
    jclass detectionResultClass = env->FindClass("com/sq/rknn/rknnyolov8pose/DetectionResult");
    jclass objectResultClass = env->FindClass("com/sq/rknn/rknnyolov8pose/DetectionResult$ObjectResult");
    ...
    jmethodID addMethod = env->GetMethodID(detectionResultClass, "addObjectResult", "(Lcom/sq/rknn/rknnyolov8pose/DetectionResult$ObjectResult;)V");
